...
router.register(r"countries", CountryModelViewSet, basename="cities-light-api-country")
router.register(r"regions", RegionModelViewSet, basename="cities-light-api-region")
router.register(
    r"subregions", SubRegionModelViewSet, basename="cities-light-api-subregion"
)
